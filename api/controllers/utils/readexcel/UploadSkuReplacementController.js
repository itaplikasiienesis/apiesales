       ...
       .upload({
        ...
        for (let i = 1; i < (excel.length); i++) {
              ...
              if(datashipto.recordset.length==0 || m_distributor_id==null){
                ...
                if(kode_soldto!=datashipto.recordset[0].kode_pajak){
                  errorValidation.push(`Kode Soldto ${kode_soldto} tidak valid dengan data esales kode tersebut bukan kode soldto dari shipto ${kode_shipto} cek baris ${baris} pada template upload`);
                }
              }
            ...
            for (let i = 1; i < (excel.length); i++) {
              ...
              if(datacmo.recordset.length > 0){
                    ...
                    if(dataorder.recordset.length > 0){
                        ...
                        // let grossFrom = datapricelistfrom.length > 0 ? datapricelistfrom.recordset[0].gross : 0;
                        // let nettFrom = datapricelistfrom.length > 0 ? datapricelistfrom.recordset[0].nett : 0;

                        // let grossTo = datapricelistfrom.length > 0 ? datapricelistTo.recordset[0].gross : 0;
                        // let nettTo = datapricelistfrom.length > 0 ? datapricelistTo.recordset[0].nett : 0;
